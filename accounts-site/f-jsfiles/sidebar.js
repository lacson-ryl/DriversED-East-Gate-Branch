    ...
    <ul class="flex flex-1 flex-col gap-4 font-light text-base">
        ...
        <li id="manage-people"
            ...
            <a class="side-nav-link flex flex-row items-center w-full gap-5" href="/account/manage-people">
                <img src="/account/f-assets/solid/white/user-group.svg" class="side-icons" />
        ...
        <li id="applicants"
            ...
            <a class="side-nav-link flex flex-row items-center w-full gap-5" href="/account/applicants">
                <img src="/account/f-assets/solid/white/identification.svg" class="side-icons" />
        ...
        <li id="search" class="flex flex-row items-center rounded-3xl hover:font-bold py-1 px-2 hover:hover-bg-custom">
            <a class="side-nav-link flex flex-row items-center w-full gap-5" href="/account/search">
                <img src="/account/f-assets/solid/white/search-circle.svg" class="side-icons" />
                <span>Search</span>
            </a>
        </li>
        <li id="requests"
        ...
        <li id="certificates"
            ...
            <a class="side-nav-link flex flex-row items-center w-full gap-5" href="/account/certificates">
                <img src="/account/f-assets/solid/white/star.svg" class="side-icons" />
...
const iconMap = {
  "/account/admin-dashboard": "/account/f-assets/solid/black/view-grid.svg",
  "/account/manage-people": "/account/f-assets/solid/black/user-group.svg",
