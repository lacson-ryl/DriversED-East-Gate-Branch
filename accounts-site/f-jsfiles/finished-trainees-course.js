                              ...
                              ${
                                arr.certificate_file
                                  ...
                                  <button data-id="${arr.course_id}" data-user-id="${arr.user_id}" data-instructor-id="${arr.instructor_id}" 
                                    ...
                                    <img src="/account/f-assets/solid/white/plus.svg" class="w-6 h-6 reverse-color scale-150" />
                                  </button>
                                  ...
                                  class="certification-create-btn bg-blue-600 rounded-md px-2 hover:underline">
                                    <img src="/account/f-assets/solid/icons_for_buttons/newspaper.svg" class="w-6 h-6 reverse-color" />
                                  </button>
                                  `
                              }
                          </div>
